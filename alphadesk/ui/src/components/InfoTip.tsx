...
export function InfoTip({
  ...
  return (
    <span className={cn("group/tip relative inline-flex cursor-help", className)}>
      ...
      <span
        role="tooltip"
        className="pointer-events-none absolute bottom-full left-1/2 z-50 mb-1 hidden -translate-x-1/2 whitespace-normal border border-border bg-popover px-1.5 py-1 text-[12px] font-normal normal-case leading-snug tracking-normal text-popover-foreground shadow-md group-hover/tip:block"
